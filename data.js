var months = [
    { len: 31, color: "#559abd", label: "January", id: "january" },
    { len: 28, color: "#5eb2d1", label: "February", id: "february" },
    { len: 31, color: "#479e74", label: "March", id: "march" },
    { len: 30, color: "#7fad4e", label: "April", id: "april" },
    { len: 31, color: "#b6c75a", label: "May", id: "may" },
    { len: 30, color: "#ebb33b", label: "June", id: "june" },
    { len: 31, color: "#e5a550", label: "July", id: "july" },
    { len: 31, color: "#e58167", label: "August", id: "august" },
    { len: 30, color: "#e06580", label: "September", id: "september" },
    { len: 31, color: "#b5518a", label: "October", id: "october" },
    { len: 30, color: "#6e4496", label: "November", id: "november" },
    { len: 31, color: "#4a4599", label: "December", id: "december" }
];
...
function getData() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (periodInterval.startDate.getMonth() === periodInterval.endDate.getMonth()) {
            ...
            currentSegments.push(createSegment(periodInterval.startDate.getMonth(), start, end, period, periodInterval));
            continue;
        }
        ...
        currentSegments.push(createSegment(periodInterval.endDate.getMonth(), start, end, period, periodInterval));
    }
...
function createSegment(month, start, end, period, periodInterval) {
